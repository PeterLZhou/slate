...
class Form extends React.Component {
  ...
  handleSubmit = event => {
    liveTr(this.state.productDescription, {
      targetLanguages: ["zh"],
      originalLanguage: "en",
      projects: ["test-project"],
      description: "This is a product listing",
...
The liveTr function is exposed in the autogenerated LangClient. The function attempts to return a translation for PHRASE by doing a lookup inside of translations.json. If no translation is found, it will asynchronously make a request for translation to our servers.
...
- `config`: an object that should have the following keys:
  ...
  - `targetLanguages`: an array of string language codes representing the target languages you want to translate the phrase into.
  - `projects` (optional): an array of strings containing the project names you want to request translations for. If you only own one project, this is optional. Otherwise, you must supply a project name.
  ...
  - `isTest` (optional): Defaults to true. If set to false, human translations for the phrase will be requested, otherwise machine translations will be requested.
...
- `config`: an object that should have the following keys:
  - `originalLanguage`: a string representing the language code of the original language.
  - `targetLanguage`: a string representing the requested target langauge.
  - `projects` (optional): an array of strings containing the project names you want to look at for the requested translation. If you only own one project, this is optional. Otherwise, you must supply a project name.
  - `description` (optional): a string representing the description of the phrase. If provided, the phrase + description will serve as the unique lookup.
